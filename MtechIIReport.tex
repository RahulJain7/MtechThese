...
Before simulating a model, openmodelica instanciate it by itself. It is at this stage that openmodelica's compiler collects all the equations and dumps them in the \textbf{equation section} of the instantiated model. Figure \ref{8.3} shows the instance of the flash model as generated by openmodelica. It is clear that now this model involves both the modeling equations and the thermodynamic equations. 
\begin{figure}
\centering
