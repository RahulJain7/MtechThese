...
\begin{figure}
\centering
\includegraphics[width=1.2\linewidth]{Combmodel}
...
Combining the bubble point and the dew point curves as generated above gives the T-xy curve for the system as shown in Figure \ref{fig:VLE}
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{VLE}
\caption{T-xy curve for ethanol water system generated in OpenModelica}
\label{fig:VLE}
\end{figure}
